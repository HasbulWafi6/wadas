...
{
	function insert_master($nomor_nota, $tanggal, $id_kasir, $id_perusahaan, $bayar, $grand_total, $catatan)
	{
		$dt = array(
			...
			'id_perusahaan' => (empty($id_perusahaan)) ? NULL : $id_perusahaan,
			'id_user' => $id_kasir
		);
	...
	function fetch_data_penjualan($like_value = NULL, $column_order = NULL, $column_dir = NULL, $limit_start = NULL, $limit_length = NULL)
	{
		$sql = "
			...
			FROM 
				...
				LEFT JOIN `pj_pelanggan` AS b ON a.`id_perusahaan` = b.`id_perusahaan` 
