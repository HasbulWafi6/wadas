            ...
            <div class="table-responsive">
              ...
              <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  $no = 1;
                  ?>
                  <?php foreach ($kategori as $cmp): ?>
                  <tr>
                    <td width="150">
                      <?php echo $no++ ?>
                    </td>
                    <td width="150">
                      <?php echo $cmp->kategori ?>
                    </td>
                    <td width="250">
                      <a href="<?php echo site_url('admin/kategori/edit/'.$cmp->id_kategori_barang) ?>"
                       class="btn btn-warning"><i class="fas fa-edit"></i> Edit</a>
                       <a href="<?php echo site_url('admin/kategori/delete/'.$cmp->id_kategori_barang) ?>" class="btn btn-danger" role="button"><i class="fas fa-trash"></i> Hapus</a>
                    </td>
                  </tr>
                  <?php endforeach; ?>
