            ...
            <div class="card card-primary">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="<?= site_url('perusahaan/index_post') ?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="number" name="telp" min="0" placeholder="Telp" />
                  </div>
