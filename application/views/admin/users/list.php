        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <div class="card mb-3">
          <div class="card-header">
            <a href="<?php echo site_url('admin/users/add') ?>" class="btn btn-info"><i class="fas fa-plus"></i> Add New</a>
          </div>
          <div class="card-body">
              ...
              <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td width="250">
                      <a href="<?php echo site_url('admin/users/edit/'.$usr->user_id) ?>"
                       class="btn btn-warning"><i class="fas fa-edit"></i> Edit</a>
                       <a href="<?php echo site_url('admin/users/delete/'.$usr->user_id) ?>" class="btn btn-danger" role="button"><i class="fas fa-trash"></i> Hapus</a>
                    </td>
                  </tr>
                  <?php endforeach; ?>
