            ...
            <div class="card card-primary">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="<?= site_url('users/index_post') ?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="email" min="0" placeholder="Email" />
                  </div>

                  <div class="form-group">
                    <label for="price">Phone*</label>
                    <input class="form-control" type="number" name="phone" min="0" placeholder="Phone" />
                  </div>
