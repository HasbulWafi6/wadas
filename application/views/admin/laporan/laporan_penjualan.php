<?php if($penjualan->num_rows() > 0) { ?>
	...
	<p>
		...
		?>
		<a href="<?php echo site_url('admin/laporan/pdf/'.$from.'/'.$to); ?>" target='blank' class='btn btn-default'><img src="<?php echo base_url('assets/img/pdf.png') ?>"> Export ke PDF</a>
		<a href="<?php echo site_url('admin/laporan/excel/'.$from.'/'.$to); ?>" target='blank' class='btn btn-default'><img src="<?php echo base_url('assets/img/xls.png') ?>"> Export ke Excel</a>
	</p>
	<br />
<?php } ?>
