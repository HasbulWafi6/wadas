          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  <?php echo form_open('admin/items/updateitem');?>
                  <div class="form_error" style="color:red;text-align:center;margin-bottom:20px;">
                    <?php echo validation_errors(); ?>
                  </div>
                  <div class="form-group">
                    <label for="name">Kode Barang*</label>
                    <input class="form-control" type="text" name="kode_barang" value="<?=$data->kode_barang?>" placeholder="Kode Barang" />
                  </div>                  
                  <div class="form-group">
                    <label for="price">Nama Barang*</label>
                    <input class="form-control" type="text" name="nama_barang" min="0" value="<?=$data->nama_barang?>" placeholder="Nama Barang" />
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="number" name="total_stok" value="<?=$data->total_stok?>" min="0" placeholder="Stock" />
                  </div>
                  <div class="form-group">
                    <label for="price">Harga*</label>
                    <input class="form-control" type="number" name="harga" min="0" value="<?=$data->harga?>" placeholder="Harga" />
                  </div>
                  <div class="form-group">
                    <label for="price">Keterangan</label>
                    <input class="form-control" type="text" name="keterangan" min="0" value="<?=$data->keterangan?>" placeholder="Keterangan" />
                  </div>
                    <!-- ID -->
