        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <div class="card mb-3">
          <div class="card-header">
            <a href="<?php echo site_url('admin/penjualan/transaksi') ?>" class="btn btn-info"><i class="fas fa-plus"></i> Add New</a>
          </div>
          <div class="card-body">
            ...
            <div class="table-responsive">
              ...
              <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  $no = 1;
                  ?>
                  <?php foreach ($penjualan as $itm): ?>
                  <tr>
                    <td width="150">
                      <?php echo $no++ ?>
                    </td>
                    <td width="150">
                      <?php echo $itm->nomor_nota ?>
                    </td>
                    <td>
                      <?php echo $itm->nama_perusahaan ?>
                    </td>
                    <td>
                      <?php echo $itm->grand_total ?>
                    </td>
                    <td>
                      <?php echo $itm->pic ?>
                    </td>
                    <td>
                      <?php echo $itm->tanggal ?>
                    </td>
                    <td width="250">
                      <a href="<?php echo site_url('admin/penjualan/detail/'.$itm->id_penjualan_m) ?>"
