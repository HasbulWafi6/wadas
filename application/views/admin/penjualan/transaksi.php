        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <div class="card mb-3">
              	 <div class="card-header">
                  <a href="<?php echo site_url('admin/penjualan/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
                </div>
		          <div class="card-body">
		              ...
		              <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
		                ...
		                <tbody>
		                  <tr>
		                    ...
		                    <td>
		                      <input type='text' name='tanggal' class='form-control input-sm' id='tanggal' value="<?php echo date('Y-m-d H:i:s'); ?>" readonly>
		                    </td>
		                    <td>
		                      <input type='text' name='id_kasir2' class='form-control input-sm' id='id_kasir2' value="<?php echo $this->session->userdata('username'); ?>" readonly>
		                      <input type='hidden' name='id_kasir' class='form-control input-sm' id='id_kasir' value="<?php echo $this->session->userdata('user_id'); ?>" >
		                    </td>
		                  </tr>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Penjualan Transaksi</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div class="card mb-3">
            ...
            <div class="table-responsive">
              ...
              <div class="flash-data" data-flashdata="<?php echo $this->session->flashdata('success');?>"></div>
              <div class="flash-data" data-flashdata="<?php echo $this->session->flashdata('delete');?>"></div>
              <table class="table table-hover" width="100%" cellspacing="0" id='TabelTransaksi'>
                	<thead>
							<tr>
...
$(document).ready(function(){
	...
	$('#id_perusahaan').change(function(){
		...
		{
			$.ajax({
				url: "<?php echo site_url('admin/penjualan/ajax_pelanggan'); ?>",
				type: "POST",
				cache: false,
...
function AutoCompleteGue(Lebar, KataKunci, Indexnya)
{
	...
	$.ajax({
		url: "<?php echo site_url('admin/penjualan/ajax_kode'); ?>",
		type: "POST",
		cache: false,
...
function SimpanTransaksi()
{
	...
	FormData += "&id_perusahaan="+$('#id_perusahaan').val();
	...
	$.ajax({
		url: "<?php echo site_url('admin/penjualan/transaksi'); ?>",
		type: "POST",
		cache: false,
		data: FormData,
		dataType:'json',
...
function CetakStruk()
{
	if($('#TotalBayarHidden').val() > 0)
	{
		if($('#UangCash').val() !== '')
		{
			...
			window.open("<?php echo site_url('admin/penjualan/transaksi-cetak/?'); ?>" + FormData,'_blank');
		}
		else
		{
			$('.modal-dialog').removeClass('modal-lg');
